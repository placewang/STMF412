...
void CAN_Receive(CAN_TypeDef* CANx, uint8_t FIFONumber, CanRxMsg* RxMessage)
{
  ...
  #else
  *(int *)(&(RxMessage->Data[0])) = CANx->sFIFOMailBox[FIFONumber].RDLR;
   *(int *)(&(RxMessage->Data[4])) = CANx->sFIFOMailBox[FIFONumber].RDHR;
...
void CAN_Receive_ex(CAN_TypeDef* CANx, uint8_t FIFONumber, CanRxMsg* RxMessage)
{
  /* Check the parameters */
  assert_param(IS_CAN_ALL_PERIPH(CANx));
  assert_param(IS_CAN_FIFO(FIFONumber));
